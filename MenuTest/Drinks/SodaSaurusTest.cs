...
//1. The ability to set each possible flavor
        ...
        {
            Sodasaurus soda = new Sodasaurus();
            Assert.PropertyChanged(soda, "Description", () => soda.Size = s);
        }
        ...
        {
            Sodasaurus soda = new Sodasaurus();
            Assert.PropertyChanged(soda, "Price", () => soda.Size = s);
        }
        ...
        public void SpecialShouldHoldIce()
        {
            Sodasaurus soda = new Sodasaurus();
            soda.HoldIce();
            Assert.Collection<string>(soda.Special, item => { Assert.Equal("Hold Ice", item); });
        }
